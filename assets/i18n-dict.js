...
window.CG_DICT = {
    fr: {
      pg_index_title: "ChatGenius.pro | Applis IA, sites web et formation IA pratique",
      pg_index_desc: "ChatGenius.pro crée des applis IA, des sites web professionnels et des produits numériques, et propose une formation IA pratique pour les entreprises à 890 NOK par heure.",
      ...
      nav_apps: "Applis", nav_trial: "Site d'essai", nav_build: "Ce que nous créons", nav_training: "Formation", nav_products: "Produits", nav_articles: "Articles", nav_contact: "Contact",
      ...
      hero_copy: "Nous créons des applis IA par abonnement, des sites web professionnels avec réceptionniste IA intégrée et une formation IA pratique pour les équipes qui veulent utiliser les bonnes possibilités. Voyez votre nouveau site gratuitement — ou réservez un plan de formation à partir de 890 NOK par heure.",
      ...
      sv_copy: "Sites web, chatbots, tableaux de bord, applis et formation pratique. Construits vite, livrés finis, gérés pour vous — ou transmis à votre équipe.",
      ...
      tr_eyebrow: "Formation IA et conseil", tr_title: "Apprenez à utiliser l'IA pour un travail qui fait vraiment avancer l'entreprise",
      tr_copy: "Pour les clients qui veulent comprendre les possibilités, utiliser les bons outils IA et construire de meilleurs flux de travail. Je travaille concrètement avec l'IA depuis le début de 2022 et j'enseigne ce qui fonctionne quand les idées doivent devenir actions, applis, automatisations et meilleures décisions.",
      tr_price: "890 NOK", tr_price_note: "par heure, avec objectifs, plan par phases et estimation avant le démarrage.",
      tr_cta1: "Réserver un plan de formation", tr_cta2: "Voir les produits", tr_panel_t: "Ce que vous pouvez apprendre",
      tr_l1: "Quand utiliser ChatGPT, Claude, Perplexity, Gemini ou d'autres outils IA.",
      tr_l2: "Des prompts qui poussent l'IA à produire des solutions plus précises, créatives et utilisables.",
      tr_l3: "Flux créatif pour contenu, concepts, image builders, images, vidéo, campagnes et idées.",
      tr_l4: "Flux analytique pour recherche, documents, aide à la décision et reporting.",
      tr_l5: "Comment applis, backend, base de données et automatisations fonctionnent ensemble en pratique.",
      tr_l6: "Quels langages, bases de données et choix backend sont raisonnables pour votre cas.",
      tr_p1_label: "Phase 1", tr_p1_t: "Cartographie", tr_p1_p: "Nous définissons les objectifs, le niveau, les cas d'usage et les processus à améliorer d'abord.",
      tr_p2_label: "Phase 2", tr_p2_t: "Formation pratique", tr_p2_p: "Nous travaillons sur vos propres tâches, construisons des workflows et créons des prompts réutilisables.",
      tr_p3_label: "Phase 3", tr_p3_t: "Documentation et suite", tr_p3_p: "Vous recevez des recettes, des recommandations d'outils, une estimation et un plan pour ce qui doit être construit ensuite.",
      ...
      ct_eyebrow: "Lancez-vous", ct_title: "Prêt à créer ou apprendre quelque chose d'intelligent ?",
      ct_copy: "Commencez par un site d'essai gratuit, abonnez-vous à une appli ou réservez une formation IA avec objectifs, phases et estimation avant le démarrage.",
      ct_cta1: "Site d'essai gratuit", ct_cta_training: "Réserver une formation",
      chk_t: "Pourquoi ChatGenius", chk1: "Voyez le résultat avant de payer", chk2: "Réceptionniste IA active 24h/24", chk3: "Prix fixes — aucune surprise", chk4: "Hébergement, SSL et gestion inclus", chk5: "Formation IA avec plan par phases et estimation",
    ...
    es: {
      ...
      pg_index_desc: "ChatGenius.pro crea apps de IA, webs profesionales y productos digitales, y ofrece formación práctica en IA para empresas a 890 NOK por hora.",
      ...
      nav_apps: "Apps", nav_trial: "Sitio de prueba", nav_build: "Qué creamos", nav_training: "Formación", nav_products: "Productos", nav_articles: "Artículos", nav_contact: "Contacto",
      ...
      hero_copy: "Creamos apps de IA por suscripción, webs profesionales con recepcionista de IA integrada y formación práctica en IA para equipos que quieren usar las oportunidades correctas. Vea su nueva web gratis — o reserve un plan de formación desde 890 NOK por hora.",
      ...
      sv_copy: "Webs, chatbots, dashboards, apps y formación práctica. Construidos rápido, entregados listos, gestionados por nosotros — o enseñados a su equipo.",
      ...
      tr_eyebrow: "Formación y asesoría en IA", tr_title: "Aprenda a usar IA para trabajo que realmente mueve la empresa",
      tr_copy: "Para clientes que quieren entender las posibilidades, usar las herramientas de IA adecuadas y crear mejores flujos de trabajo. Trabajo de forma práctica con IA desde principios de 2022 y enseño lo que funciona cuando las ideas deben convertirse en acciones, apps, automatizaciones y mejores decisiones.",
      tr_price: "890 NOK", tr_price_note: "por hora, con objetivos, plan por fases y estimación antes de empezar.",
      tr_cta1: "Reservar plan de formación", tr_cta2: "Ver productos", tr_panel_t: "Qué puede aprender",
      tr_l1: "Cuándo usar ChatGPT, Claude, Perplexity, Gemini u otras herramientas de IA.",
      tr_l2: "Prompts que fuerzan a la IA a dar soluciones más precisas, creativas y utilizables.",
      tr_l3: "Flujo creativo para contenido, conceptos, image builders, imágenes, vídeo, campañas e ideas.",
      tr_l4: "Flujo analítico para investigación, documentos, apoyo a decisiones e informes.",
      tr_l5: "Cómo apps, backend, base de datos y automatizaciones encajan en la práctica.",
      tr_l6: "Qué lenguajes, bases de datos y opciones backend tienen sentido para su caso.",
      tr_p1_label: "Fase 1", tr_p1_t: "Mapeo", tr_p1_p: "Definimos objetivos, nivel, casos relevantes y qué procesos conviene mejorar primero.",
      tr_p2_label: "Fase 2", tr_p2_t: "Formación práctica", tr_p2_p: "Entrenamos con sus propias tareas, construimos workflows y creamos prompts reutilizables.",
      tr_p3_label: "Fase 3", tr_p3_t: "Documentación y siguiente plan", tr_p3_p: "Recibe recetas, recomendaciones de herramientas, estimación de costes y un plan de lo que debería construirse después.",
      ...
      ct_eyebrow: "Empiece ya", ct_title: "¿Listo para crear o aprender algo inteligente?",
      ct_copy: "Empiece con un sitio de prueba gratis, suscríbase a una app o reserve formación en IA con objetivos, fases y estimación antes de empezar.",
      ct_cta1: "Sitio de prueba gratis", ct_cta_training: "Reservar formación",
      chk_t: "Por qué ChatGenius", chk1: "Vea el resultado antes de pagar", chk2: "Recepcionista de IA activa 24/7", chk3: "Precios fijos — sin sorpresas", chk4: "Hosting, SSL y gestión incluidos", chk5: "Formación en IA con plan por fases y estimación",
      footer_top: "Arriba",
    ...
    de: {
      ...
      pg_index_desc: "ChatGenius.pro baut KI-Apps, professionelle Websites und digitale Produkte und bietet praktische KI-Schulung für Unternehmen für 890 NOK pro Stunde.",
      ...
      nav_apps: "Apps", nav_trial: "Testseite", nav_build: "Was wir bauen", nav_training: "Schulung", nav_products: "Produkte", nav_articles: "Artikel", nav_contact: "Kontakt",
      ...
      hero_copy: "Wir bauen KI-Apps im Abo, professionelle Websites mit integrierter KI-Rezeption und praktische KI-Schulung für Teams, die die richtigen Möglichkeiten nutzen wollen. Sehen Sie Ihre neue Website kostenlos — oder buchen Sie einen Schulungsplan ab 890 NOK pro Stunde.",
      ...
      sv_copy: "Websites, Chatbots, Dashboards, Apps und praktische Schulung. Schnell gebaut, fertig geliefert, für Sie betrieben — oder Ihrem Team beigebracht.",
      ...
      tr_eyebrow: "KI-Schulung und Beratung", tr_title: "Lernen Sie, KI für Arbeit zu nutzen, die Ihr Unternehmen wirklich voranbringt",
      tr_copy: "Für Kunden, die die Möglichkeiten verstehen, die richtigen KI-Tools nutzen und bessere Workflows bauen wollen. Ich arbeite seit Anfang 2022 praktisch mit KI und vermittle, was funktioniert, wenn Ideen zu Aktionen, Apps, Automatisierungen und besseren Entscheidungen werden sollen.",
      tr_price: "890 NOK", tr_price_note: "pro Stunde, mit Zielsetzung, Phasenplan und Schätzung vor dem Start.",
      tr_cta1: "Schulungsplan buchen", tr_cta2: "Produkte ansehen", tr_panel_t: "Was Sie lernen können",
      tr_l1: "Wann ChatGPT, Claude, Perplexity, Gemini oder andere KI-Tools sinnvoll sind.",
      tr_l2: "Prompting, das KI zu präziseren, kreativeren und nutzbaren Lösungen bringt.",
      tr_l3: "Kreativer Workflow für Inhalte, Konzepte, Image Builder, Bilder, Video, Kampagnen und Ideen.",
      tr_l4: "Analytischer Workflow für Recherche, Dokumente, Entscheidungsunterstützung und Reporting.",
      tr_l5: "Wie Apps, Backend, Datenbank und Automatisierungen praktisch zusammenhängen.",
      tr_l6: "Welche Programmiersprachen, Datenbanken und Backend-Optionen für Ihren Fall sinnvoll sind.",
      tr_p1_label: "Phase 1", tr_p1_t: "Analyse", tr_p1_p: "Wir definieren Ziele, Niveau, relevante Fälle und welche Prozesse zuerst verbessert werden sollten.",
      tr_p2_label: "Phase 2", tr_p2_t: "Praktische Schulung", tr_p2_p: "Wir trainieren an Ihren eigenen Aufgaben, bauen Workflows und erstellen wiederverwendbare Prompts.",
      tr_p3_label: "Phase 3", tr_p3_t: "Dokumentation und nächster Plan", tr_p3_p: "Sie erhalten Rezepte, Tool-Empfehlungen, eine Kostenschätzung und einen Plan für den weiteren Aufbau.",
      ...
      ct_eyebrow: "Loslegen", ct_title: "Bereit, etwas Smartes zu bauen oder zu lernen?",
      ct_copy: "Starten Sie mit einer gratis Testseite, abonnieren Sie eine App oder buchen Sie KI-Schulung mit Zielen, Phasenplan und Schätzung vor dem Start.",
      ct_cta1: "Gratis Testseite", ct_cta_training: "Schulung buchen",
      chk_t: "Darum ChatGenius", chk1: "Ergebnis sehen, bevor Sie zahlen", chk2: "KI-Rezeption arbeitet 24/7", chk3: "Festpreise — keine Überraschungen", chk4: "Hosting, SSL und Betrieb inklusive", chk5: "KI-Schulung mit Phasenplan und Kostenschätzung",
    ...
    ru: {
      ...
      pg_index_desc: "ChatGenius.pro создаёт ИИ-приложения, профессиональные сайты и цифровые продукты, а также предлагает практическое обучение ИИ для компаний за 890 NOK в час.",
      ...
      nav_apps: "Приложения", nav_trial: "Пробный сайт", nav_build: "Что мы делаем", nav_training: "Обучение", nav_products: "Продукты", nav_articles: "Статьи", nav_contact: "Контакты",
      ...
      hero_copy: "Мы создаём ИИ-приложения по подписке, профессиональные сайты со встроенным ИИ-администратором и практическое обучение ИИ для команд, которые хотят использовать правильные возможности. Увидьте новый сайт бесплатно — или забронируйте план обучения от 890 NOK в час.",
      ...
      sv_copy: "Сайты, чат-боты, дашборды, приложения и практическое обучение. Строим быстро, сдаём готовыми, обслуживаем за вас — или обучаем вашу команду.",
      ...
      tr_eyebrow: "Обучение ИИ и консультации", tr_title: "Научитесь использовать ИИ для работы, которая реально двигает бизнес",
      tr_copy: "Для клиентов, которые хотят понимать возможности, использовать правильные ИИ-инструменты и строить лучшие рабочие процессы. Я практически работаю с ИИ с начала 2022 года и обучаю тому, что работает, когда идеи нужно превратить в действия, приложения, автоматизацию и лучшие решения.",
      tr_price: "890 NOK", tr_price_note: "в час, с целями, планом по фазам и оценкой стоимости до старта.",
      tr_cta1: "Забронировать план обучения", tr_cta2: "Смотреть продукты", tr_panel_t: "Чему можно научиться",
      tr_l1: "Когда использовать ChatGPT, Claude, Perplexity, Gemini или другие ИИ-инструменты.",
      tr_l2: "Промпты, которые заставляют ИИ давать более точные, творческие и применимые решения.",
      tr_l3: "Креативный workflow для контента, концепций, image builders, изображений, видео, кампаний и идей.",
      tr_l4: "Аналитический workflow для исследований, документов, поддержки решений и отчётности.",
      tr_l5: "Как приложения, backend, база данных и автоматизация связаны на практике.",
      tr_l6: "Какие языки программирования, базы данных и backend-решения разумны для вашего кейса.",
      tr_p1_label: "Фаза 1", tr_p1_t: "Картирование", tr_p1_p: "Мы определяем цели, уровень, актуальные кейсы и процессы, которые стоит улучшить первыми.",
      tr_p2_label: "Фаза 2", tr_p2_t: "Практическое обучение", tr_p2_p: "Мы тренируемся на ваших задачах, строим workflows и создаём промпты, которые можно использовать снова.",
      tr_p3_label: "Фаза 3", tr_p3_t: "Документация и дальнейший план", tr_p3_p: "Вы получаете рецепты, рекомендации по инструментам, оценку стоимости и план того, что стоит строить дальше.",
      ...
      ct_eyebrow: "Начните сейчас", ct_title: "Готовы создать или изучить что-то умное?",
      ct_copy: "Начните с бесплатного пробного сайта, подпишитесь на приложение или забронируйте обучение ИИ с целями, фазами и оценкой стоимости до старта.",
      ct_cta1: "Бесплатный пробный сайт", ct_cta_training: "Забронировать обучение",
      chk_t: "Почему ChatGenius", chk1: "Видите результат до оплаты", chk2: "ИИ-администратор работает 24/7", chk3: "Фиксированные цены — без сюрпризов", chk4: "Хостинг, SSL и обслуживание включены", chk5: "Обучение ИИ с планом по фазам и оценкой стоимости",
      footer_top: "Наверх",
